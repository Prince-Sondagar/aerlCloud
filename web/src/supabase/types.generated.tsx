  ...
  public: {
    Tables: {
      ...
      device_schema: {
        ...
        Relationships: [
          {
            foreignKeyName: "public_device_schema_device_type_fkey"
            columns: ["device_type"]
            isOneToOne: false
            referencedRelation: "device_type_schema"
      ...
      gateway_network_state: {
        ...
        Relationships: [
          {
            foreignKeyName: "public_gateway_network_state_id_fkey"
            columns: ["id"]
            isOneToOne: true
      ...
      gateways: {
        ...
        Relationships: [
          {
            foreignKeyName: "gateways_hub_id_fkey"
            columns: ["hub_id"]
            isOneToOne: true
          ...
          {
            foreignKeyName: "gateways_location_id_fkey"
            columns: ["location_id"]
            isOneToOne: false
      ...
      modbus_device: {
        ...
        Relationships: [
          {
            foreignKeyName: "modbus_device_gateway_id_fkey"
            columns: ["gateway_id"]
            isOneToOne: false
            referencedRelation: "decrypted_hub"
            referencedColumns: ["id"]
      ...
      modbus_interface: {
        ...
        Relationships: [
          {
            foreignKeyName: "modbus_interface_gateway_id_fkey"
            columns: ["gateway_id"]
            isOneToOne: false
            referencedRelation: "gateways"
            referencedColumns: ["id"]
      ...
      modbus_product: {
        ...
        Relationships: [
          {
            foreignKeyName: "public_modbus_product_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "device_schema"
            referencedColumns: ["id"]
          }
        ]
      }
