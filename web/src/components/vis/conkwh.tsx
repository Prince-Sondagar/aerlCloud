...
export default function ConKWH({ measurement, query, unit, selectedHubs, refetch }: {
  measurement: string,
  query?: string,
  unit?: string,
        ...
        <CardBody>
          ...
          <div className="gap-4 mx-auto">
            {loading ? (
              ...
              <span className="text-textColor flex items-center text-[32px] font-semibold">-- <p className="text-secondaryText text-2xl ps-2">{data.prefix}{unit}</p></span>
            ) : (
